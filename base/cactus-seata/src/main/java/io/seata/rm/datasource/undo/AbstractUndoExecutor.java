...
import com.cactus.seata.CustomizeDataValidation;
...
public abstract class AbstractUndoExecutor {
    ...
    private final CustomizeDataValidation customizeDataValidation = new CustomizeDataValidation();
    /**
    ...
    protected boolean dataValidationAndGoOn(Connection conn) throws SQLException {
        ...
        if (!afterEqualsCurrentResult.getResult()) {
            ...
            if (beforeEqualsCurrentResult.getResult()) {
                ...
                //add customize data validate
                if(customizeDataValidation.isRecordsEquals(afterRecords, currentRecords).getResult()){
                    // no need continue undo.
                    return false;
                }
                if (LOGGER.isInfoEnabled()) {
